...
class VMAdapter:
    ...
    async def shutdown_worker(self, worker_id: str):
    ...
    async def webhook_handler(self, request: Request):
        ...
        if action == "start_worker":
            ...
            return web.json_response({"status": "Worker started"}, status=200)
            ...
            return web.json_response({"status": "Worker shutdown"}, status=200)
