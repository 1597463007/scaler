...
def get_args():
    ...
    parser.add_argument("--port", "-p", type=int, default=None, help="port for the VM adapter HTTP server")
    ...
    parser.add_argument(
        ...
        help="number of tasks can be queued to each worker",
    )
    parser.add_argument(
        "--heartbeat-interval",
        "-hi",
...
def main():
    ...
    vm_adapter = VMAdapter(
        ...
        task_queue_size=args.task_queue_size,
